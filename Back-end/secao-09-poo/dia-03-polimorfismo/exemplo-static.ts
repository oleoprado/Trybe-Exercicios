...
class Employee1 {
  ...
  private static employeeCount = 0
    ...
    private static addEmployee() {
      ...
      Employee1.employeeCount += 1;
      console.log(`Total de pessoas funcionárias: ${Employee1.employeeCount}`)
    }
  ...
  const employee1 = new Employee1('Kissyla'); // Total de pessoas funcionárias: 1
  const employee2 = new Employee1('Calaça'); // Total de pessoas funcionárias: 2
  const employee3 = new Employee1('Setinha'); // Total de pessoas funcionárias: 3
