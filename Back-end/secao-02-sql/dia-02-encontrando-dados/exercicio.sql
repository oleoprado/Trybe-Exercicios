...
SELECT CONCAT ('O projeto', name, 'precisou de', hours, 'horas para ser concluído'), name, hours FROM Scientists.Projects ;
...
SELECT COUNT(*)  AS 'Existem Number cientistas na tabela Scientists.' FROM Scientists.Scientists;
